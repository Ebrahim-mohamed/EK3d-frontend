...
export function ValueBox({ title, pra,icon }: { title: string; pra: string ,icon:string}) {
  return (
  ...
  w-full max-w-[80%] h-56 max-[800px]:w-[80%] max-[800px]:max-w-full
  bg-[#d9d9d9]/40 backdrop-blur-md
  text-[1.5rem] text-center p-4 text-white "
      >
        {pra}
      </div>
    </div>
